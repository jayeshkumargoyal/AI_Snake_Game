...
class Agent:
    ...
    def remember(self, state, action, reward, next_state, done):
        # Stores experience tuples for experience replay
    ...
    def get_action(self, state):
        ...
        self.epsilon = 80 - self.n_games    # Linear exploration decay
        final_move = [0,0,0]
